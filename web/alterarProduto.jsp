<%-- 
    ...
    Created on : 18/09/2018, 11:13:57
    Author     : PC 05
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">           
            <form name="alterarproduto" id="alterarproduto" action="AlterarProduto"  method="POST">
                <div class="form-row">
                     <div class="form-group">
                        <label for="idProduto">Id</label>
                        <input  type="text" name="idProduto" id="idProduto" class="form-control" value="${produto.idProduto}">
                    </div>
